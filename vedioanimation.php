...
<html>
    <head>
        <title>Video & Animation | Services - UFX Studio</title>
        <meta charset="UTF-8">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12 text-center">
                            <h1 class="wow fadeInUp" data-wow-duration="700ms" data-wow-delay="300ms">Video <span>&</span> Animation</h1>
...
<!-- Start WOWSlider.com BODY section --> <!-- add to the <body> of your page -->
    ...
    <div class="ws_images"><ul>
        <li><img src="data1/images/video/slider1.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/video/slider2.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/video/slider3.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/video/slider4.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/video/slider5.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/video/slider6.jpg" alt="singleEvent" title="singleEvent" id="wows1_1"/></li>
    </ul></div>
...
<!-- End WOWSlider.com BODY section -->
                                ...
                                <div class="eventSinglePost">
                                    <h2 class="wow fadeInUp" data-wow-duration="700ms" data-wow-delay="300ms"><a href="#">Video & Animation</a></h2>
