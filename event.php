...
<html>
    <head>
        <title>Event | Services - UFX Studio</title>
        <meta charset="UTF-8">
...
div#load_screen > div#loading{
    ...
    <div id="load_screen"><div id="loading">&nbsp;</div></div>
        ...
        <div class="boxWrapper">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12 text-center">
                            <h1 class="wow fadeInUp" data-wow-duration="700ms" data-wow-delay="300ms">event</h1>
                            <ul class="breadLink wow fadeInUp" data-wow-duration="700ms" data-wow-delay="350ms">
                                <li><a href="index.php">home</a><span>|</span></li>
                                <li><a href="services.php">services</a><span>|</span></li>
                                <li>Event</li>
                            </ul>
                        </div>
                    </div>
            ...
            <!-- Event Single Page -->
            <section class="blogSidebarArea commonSection postPage singleEventPage">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 ">
                            <div class="blogSidbarPost">
                                <div class="row">
								<div class="col-md-8 blogPostThumb wow fadeInUp" data-wow-duration="700ms" data-wow-delay="300ms">
                                    <!--img  alt="" src="images/events/singleEvent.jpg"-->
<!-- Start WOWSlider.com BODY section --> <!-- add to the <body> of your page -->
    <div id="wowslider-container1">
    <div class="ws_images"><ul>
        <li><img src="data1/images/event/slider1.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/event/slider2.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/event/slider3.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/event/slider4.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/event/slider5.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/event/slider6.jpg" alt="singleEvent" title="singleEvent" id="wows1_1"/></li>
    </ul></div>
    <div class="ws_bullets"><div>
        <a href="#"><span><img src="data1/tooltips/singleevent1.jpg" alt="singleEvent"/>1</span></a>
        <a href="#"><span><img src="data1/tooltips/singleevent2.jpg" alt="singleEvent"/>2</span></a>
        <a href="#"><span><img src="data1/tooltips/singleevent3.jpg" alt="singleEvent"/>3</span></a>
        <a href="#"><span><img src="data1/tooltips/singleevent4.jpg" alt="singleEvent"/>4</span></a>
        <a href="#"><span><img src="data1/tooltips/singleevent5.jpg" alt="singleEvent"/>5</span></a>
        <a href="#"><span><img src="data1/tooltips/singleevent6.jpg" alt="singleEvent"/>6</span></a>
    </div></div>
...
<!-- End WOWSlider.com BODY section -->
                                ...
                                <div class="eventSinglePost">
                                    <h2 class="wow fadeInUp " data-wow-duration="700ms" data-wow-delay="300ms"><a href="#">Event</a></h2>
                                    
                                    <div class="blogPostContent wow fadeInUp" data-wow-duration="700ms" data-wow-delay="400ms">
                                        <p>
                                          The stage belongs to you. Your company. Your product. You’re at center stage, about to give your audience a presentation that will have tremendous impact. 
										...
										<p>The most effective way to impress prospects, customers, vendors or employees is to present them with a show they’ll never forget. 
										...
										We’re known across the country for producing main-stage productions with concert-quality sound, creative staging environments, multiscreen image projection 
