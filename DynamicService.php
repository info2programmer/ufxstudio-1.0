...
{
	$globalVar=showAllServicesByID($_GET['Service']);
}
else
{
...
<html>
    <head>
        <title><?php  echo $globalVar['Name'];  ?> | Services - UFX Studio</title>
        <meta charset="UTF-8">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12 text-center">
                            <h1 class="wow fadeInUp" data-wow-duration="700ms" data-wow-delay="300ms"><?php echo $globalVar['Name'];  ?></h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 ">
                            <div class="blogSidbarPost">
                                <div class="col-md-8 blogPostThumb">
                                    <!--img  alt="" src="images/events/singleEvent.jpg"-->
<!-- Start WOWSlider.com BODY section --> <!-- add to the <body> of your page -->
    <div id="wowslider-container1">
    <div class="ws_images">
    <ul>
<?php showAllServicesImagesByID($_GET['Service']); ?>
...
<!-- End WOWSlider.com BODY section -->
                                ...
                                <div class="eventSinglePost">
                                    <h2 class="wow fadeInUp" data-wow-duration="700ms" data-wow-delay="300ms"><a href="javascript:void(0);"><?php echo $globalVar['Name'];  ?></a></h2>
                                    
                                    <div class="blogPostContent wow fadeInUp" data-wow-duration="700ms" data-wow-delay="400ms">
                                        <?php  echo $globalVar['Discription']; ?>
                                    </div>
                                </div>
                            </div>
