...
<html>
    <head>
        <title>Photography | Services - UFX Studio</title>
        <meta charset="UTF-8">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12 text-center">
                            <h1 class="wow fadeInUp" data-wow-duration="700ms" data-wow-delay="300ms">Photography</h1>
...
<!-- Start WOWSlider.com BODY section --> <!-- add to the <body> of your page -->
    ...
    <div class="ws_images"><ul>
        <li><img src="data1/images/photo/slider1.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/photo/slider2.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/photo/slider3.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/photo/slider4.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/photo/slider5.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/photo/slider6.jpg" alt="singleEvent" title="singleEvent" id="wows1_1"/></li>
    </ul></div>
...
<!-- End WOWSlider.com BODY section -->
                                ...
                                <div class="eventSinglePost">
                                    <h2 class="wow fadeInUp" data-wow-duration="700ms" data-wow-delay="300ms"><a href="#">Photography &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></h2>
                                    ...
                                    <div class="blogPostContent wow fadeInUp" data-wow-duration="700ms" data-wow-delay="400ms">
										  ...
										  corporate event, Media Productions brings creative techniques and an attentive eye to find a style that’s completely
										  your own.
										...
										creative techniques and an attentive eye to find a style that’s completely your own.<br>
