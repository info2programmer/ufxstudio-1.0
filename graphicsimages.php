...
<html>
    <head>
        <title>Graphics & Design | Services - UFX Studio</title>
        <meta charset="UTF-8">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12 text-center">
                            <h1 class="wow fadeInUp" data-wow-duration="700ms" data-wow-delay="300ms">Graphics <span>&amp;</span> Design</h1>
...
<!-- Start WOWSlider.com BODY section --> <!-- add to the <body> of your page -->
    ...
    <div class="ws_images"><ul>
        <li><img src="data1/images/graphics/slider1.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/graphics/slider2.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/graphics/slider3.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/graphics/slider4.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/graphics/slider5.jpg" alt="wow slider" title="singleEvent" id="wows1_0"/></a></li>
        <li><img src="data1/images/graphics/slider6.jpg" alt="singleEvent" title="singleEvent" id="wows1_1"/></li>
    </ul></div>
...
<!-- End WOWSlider.com BODY section -->
                                ...
                                <div class="eventSinglePost">
                                    <h2 class="wow fadeInUp" data-wow-duration="700ms" data-wow-delay="300ms"><a href="#">Graphics & Design</a></h2>
                                    
                                    <div class="blogPostContent wow fadeInUp" data-wow-duration="700ms" data-wow-delay="400ms">
                                        <p>
                                           Graphics design for us is a creative process that conveys a specific message to a target audience 
